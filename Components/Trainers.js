...
useEffect(()=>{
  ...
  console.log("----->>", vehicleType,bookLocation,trainerData)
                      ...
                      <div className="trainersame-one-part" id="trainersame-one-part">
                        ...
                        {trainerData.map((item2)=>{
                          ...
                          <div className="trainerhead-one-one">
                            ...
                            <h5> {new Date(`01/01/2000 ${item2.startTime2}`).toLocaleTimeString('en-US', {hour: 'numeric', minute: 'numeric', hour12: true})}
                             - {new Date(`01/01/2000 ${item2.endTime2}`).toLocaleTimeString('en-US', {hour: 'numeric', minute: 'numeric', hour12: true})}</h5>
                          </div>
                          <div className="trainerhead-one-one">
                        ...
                        {vehicleType?.map((item3)=>{
                          if(item2.vehicleTypesch2 == item3.id){
                            return(
                              <>
                              <h6>{item3.vehicle}</h6>
                              </>
                          ...
                          <strong>Test at {new Date(`01/01/2000 ${item2.testtime2}`).toLocaleTimeString('en-US', {hour: 'numeric', minute: 'numeric', hour12: true})}</strong>
                          <small>Location</small>
                          {bookLocation?.map((item4)=>{
                          if(item2.locationsch2 == item4.id){
                            return(
                              <>
                          ...
                          <small>Client</small>
                          <span> {item2.clientName2}({item2.mobilesch2})</span>
                        </div>
                            </>
                          )
                          }
